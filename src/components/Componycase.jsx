  ...
  return (
    <div className="bg-white text-black py-16 px-6">
      ...
      <div className="max-w-3xl mx-auto text-center space-y-4 mb-12">
        <p>We work with world-class brands to build scalable and innovative digital solutions.</p>
        <p>Our commitment to excellence has helped us partner with industry leaders across the globe.</p>
        <p>These collaborations reflect our expertise, integrity, and forward-thinking approach.</p>
      </div>
